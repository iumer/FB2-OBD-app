...
object DtcCatalog {
    ...
    private val advice = mapOf(
        ...
        "P0301" to "Cylinder 1 misfire. Swap coil/plug with another cylinder — if the code moves, the part is bad.",
        "P0302" to "Cylinder 2 misfire. Swap coil/plug with another cylinder — if the code moves, the part is bad.",
        "P0303" to "Cylinder 3 misfire. Swap coil/plug with another cylinder — if the code moves, the part is bad.",
        "P0304" to "Cylinder 4 misfire. Swap coil/plug with another cylinder — if the code moves, the part is bad.",
